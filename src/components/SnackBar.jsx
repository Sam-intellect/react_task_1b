...
const SnackBar = () => {
  ...
  return show ? (
    <div
      id="mkd-toast"
      className="absolute flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow top-5 right-5 dark:text-gray-400"
      role="alert">
      <div className="text-sm font-normal text-black">{state.globalMessage}</div>
